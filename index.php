...
// Despacho temprano para descargas (PDF/Excel) antes de imprimir HTML
if (isset($_GET['url'])) {
    ...
    $rawEndpoints = [
        'estadisticas' => [
            ...
            'exportar_datos_pdf',
            'exportar_excel',
            'exportar_datos_funnel_pdf',
            'exportar_datos_funnel_excel',
            'exportar_datos_apr_rech_pdf',
            'exportar_datos_apr_rech_excel',
